...
const SUITES = [
  {
    id: "Suite 1",
    tipus: "Quàdruple · Balcó privatiu",
    color: "#b5a48a",
    capacitat: 4,
...
const SUITE_AMENITIES = [
  { icon: "🛏️", label: "Llit doble" },
  { icon: "🚿", label: "Bany privat equipat" },
  { icon: "🧊", label: "Nevera" },
  { icon: "📺", label: "Smart TV" },
  { icon: "❄️", label: "Aire condicionat" },
  { icon: "🔥", label: "Calefacció" },
  { icon: "💻", label: "Escriptori" },
  { icon: "📶", label: "Fibra i WiFi" },
];
    ...
    <div style={s.wrap}>
      ...
      <div style={{ position: "relative", width: "100%", minHeight: 520, background: "#c4b090", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "4rem 2rem 5rem" }}>
          ...
          <h1 style={{ fontFamily: "'Palatino Linotype', Palatino, 'Book Antiqua', Georgia, serif", fontSize: "clamp(28px, 6vw, 54px)", fontWeight: 700, color: "#fff", margin: "0 0 0.6rem", letterSpacing: "0.04em", textShadow: "0 2px 12px rgba(0,0,0,0.4)" }}>
      ...
      <div style={{ background: "#faf8f4", padding: "3.5rem 2rem 0" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "Arial, sans-serif", fontSize: 15, color: "#666", lineHeight: 1.9, margin: "0 0 2.5rem" }}>
            Envoltats de vinyes i muntanyes de pissarra, al nucli medieval d'El Lloar, Casa Rural Bonavista és molt més que un allotjament. És una casa de poble autèntica amb vistes excepcionals a la comarca del Priorat, on la natura, el vi i la tranquil·litat conviuen amb un servei càlid i personalitzat.
          </p>
